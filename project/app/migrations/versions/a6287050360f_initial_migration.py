...
Revision ID: a6287050360f
Revises: 
Create Date: 2024-06-11 14:51:32.227066
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['status_id'], ['review_statuses.id'], name=op.f('fk_comments_status_id_review_statuses')),
